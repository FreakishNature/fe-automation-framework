...
public class WebDriverActions {
    ...
    public void switchToIFrame(BaseElement iFrame) {
    ...
    public void clickMultipleCustomElementsWithCtrl(List<BaseElement> elements) {
    ...
    public void dragAndDrop(BaseElement element, BaseElement target) {
