...
//    public static GooglePage instance = new GooglePage("GooglePage");
    ...
    public BaseElement searchBtnX;
    public TextInput searchbarX;
    public BaseElement testEl;

    public GooglePage(String name) {
        super(name);
        PageFactory.initElements(getDriver(), this);

//        this.searchBtnX = new BaseElement(By.name("btnK"), "Search button");
//        this.searchbarX = new TextInput(By.name("q"), "Search bar", null);
        this.testEl = new BaseElement(By.xpath(".//body"), "test el");
    }
